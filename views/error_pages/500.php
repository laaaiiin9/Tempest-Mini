...
<head>
    ...
    <title><?= htmlspecialchars(Config::get('app.app_name')); ?> - 500</title>
...
<body class="min-h-screen bg-black text-slate-100 antialiased">
    <main class="flex min-h-screen items-center justify-center px-4">
        <section class="w-full max-w-2xl rounded-2xl border border-slate-800 bg-slate-950/70 p-8 shadow-2xl">
            ...
            <a href="/" class="mt-8 inline-flex rounded-md bg-red-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-red-400">
                Back to Home
            </a>
        </section>
    </main>
